...
(function() {
    ...
    Loader = (function() {
      ...
      Loader.prototype.beginTests = function() {
        ...
        this.testList.push(new CubeTest('aa'));  //第一个图的
        ...
        postProgress = (function(_this) {
          return function() {
            //进度的一个函数
            progress(++_this.numComplete / _this.numberOfTests * 30.0);
        ...
        Tester = (function() {
          function Tester(testList, dest) {
            ...
            this.canvas = $("<canvas id='loading' style='text-align:center;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;opacity:1;' width='" + d + "' height='" + d + "'/>").appendTo(dest)[0];
        ...
        $("<canvas id='can_aa'  style='opacity:0;' width='" + d + "' height='" + d + "'/>").appendTo(canvasContainer);
